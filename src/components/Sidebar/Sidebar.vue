<template>
  <button
    ...
    class="p-3 w-8 h-8 rounded-md"
    :class="isSideBarVisible ? 'hidden' : ''"
  >
    <div
      class="bg-gray-900 w-8 h-8 rounded-md hover:bg-gray-800"
      id="ToggleSVG"
    >
      <svg
        class="bg-gray-900 hover:bg-gray-800 w-8 h-8 rounded-md"
        viewBox="0 0 24 24"
        fill="bg-gray-900"
  ...
  <div
    class="h-screen bg-gray-900 sm:w-64 flex flex-col justify-between"
    :class="isSideBarVisible ? '' : 'hidden'"
  >
    <div class="ml-0 z-10 h-fit relative">
      <!-- component -->
      <div
        class="rounded-r bg-gray-900 flex justify-between w-full p-6 items-center sm:w-64"
      >
      ...
      >
        ...
        >
          ...
          >
            ...
            <router-link to="/Sidebar" v-slot="{ href, route, navigate }">
              <button
                :href="href"
                @click="navigate"
                class="text-base leading-4"
        ...
        >
          ...
          >
            ...
            >
              ...
              <router-link to="/05-Methods" v-slot="{ href, route, navigate }">
                <button
                  :href="href"
                  @click="navigate"
                  class="text-base leading-4"
            ...
            >
              ...
              <router-link to="/09-Watchers" v-slot="{ href, route, navigate }">
                <button
                  :href="href"
                  @click="navigate"
                  class="text-base leading-4"
        ...
        >
          <button
            @click="toggleVisible('SectionTwo')"
          ...
          <div
            class="flex justify-start flex-col items-start pb-5"
            :class="{ hidden: this.isSectionTwoVisible }"
          >
            <button
              class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 w-full md:w-52"
            >
        ...
        <div class="flex flex-col items-center h-full pb-6 px-6 w-full">
          <button
            @click="toggleVisible('SectionThree')"
            class="focus:outline-none focus:text-indigo-400 text-white flex justify-between items-center w-full py-5 space-x-14"
          >
          ...
          <div
            id="Section 3"
            class="flex justify-start flex-col items-start pb-5"
            :class="{ hidden: this.isSectionThreeVisible }"
          >
            <button
